...
const FIXED16_SHIFT: u32 = 16;

// This matches the behaviour of SkScalarToFixed
fn f32_truncate_to_fixed16(x: f32) -> u32
{
...
impl FontRenderMode {
    ...
    fn subpixel_quantize_offset(&self, pos: f32) -> SubpixelOffset {
        ...
        const SUBPIXEL_BITS: u32 = 2;
        const SUBPIXEL_FIXED16_MASK: u32 = 0b11 << (FIXED16_SHIFT - SUBPIXEL_BITS);
