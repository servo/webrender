...
use webrender_traits::{WorldPoint, WorldPoint3D, LayerVector2D};
...
impl ClipScrollNode {
    ...
    pub fn ray_intersects_node(&self, cursor: &WorldPoint) -> bool {
        ...
        let p0 = inv.transform_point3d(&WorldPoint3D::new(cursor.x, cursor.y, z0));
        let p1 = inv.transform_point3d(&WorldPoint3D::new(cursor.x, cursor.y, z1));
