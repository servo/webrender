...
#[derive(Clone, Debug)]
pub struct ClipInfo {
    /// The ClipSource for this node, assuming it is not a reference frame.
...
pub struct ClipScrollNode {
    ...
    /// Parent layer. If this is the same as the node id, this is the root node.
    pub parent: ScrollLayerId,
...
impl ClipScrollNode {
    ...
    pub fn new_reference_frame(parent_id: ScrollLayerId,
                               local_viewport_rect: &LayerRect,
                               content_size: LayerSize,
