...
use util::{LayerToWorldTransformOrOffset, LayerTransformOrOffset, LayoutTransformOrOffset};
use util::{TransformOrOffset, TransformedRectKind};
...
pub struct ClipScrollNode {
    ...
    pub world_viewport_transform: LayerToWorldTransformOrOffset,

    /// World transform for content transformed by this node.
    pub world_content_transform: LayerToWorldTransformOrOffset,
    ...
    pub coordinate_system_relative_transform: LayerTransformOrOffset,
...
impl ClipScrollNode {
    pub fn new(
        ...
        ClipScrollNode {
            ...
            world_viewport_transform: LayerToWorldTransformOrOffset::identity(),
            world_content_transform: LayerToWorldTransformOrOffset::identity(),
            parent: parent_id,
            children: Vec::new(),
            pipeline_id,
            node_type: node_type,
            ...
            coordinate_system_relative_transform: LayerTransformOrOffset::identity(),
    ...
    pub fn new_reference_frame(
        ...
        let info = ReferenceFrameInfo {
            resolved_transform: LayerTransformOrOffset::identity(),
    ...
    pub fn mark_uninvertible(&mut self) {
        ...
        self.world_content_transform = LayerToWorldTransformOrOffset::identity();
        self.world_viewport_transform = LayerToWorldTransformOrOffset::identity();
    }
    ...
    pub fn push_gpu_node_data(&mut self, node_data: &mut Vec<ClipScrollNodeData>) {
        ...
        let data = ClipScrollNodeData {
            transform: self.world_content_transform.to_transform(),
    ...
    pub fn update_transform_for_reference_frame(
        ...
        let source_transform = LayoutTransformOrOffset::new_transform(
            scene_properties.resolve_layout_transform(&info.source_transform)
        );
        info.resolved_transform =
            LayerTransformOrOffset::with_offset(info.origin_in_parent_reference_frame)
        ...
        let transform = TransformOrOffset::new_transform(relative_transform);
        self.world_viewport_transform = state.parent_reference_frame_transform.pre_mul(&transform);
        ...
        match state.coordinate_system_relative_transform.update(relative_transform) {
            ...
            None => {
                self.coordinate_system_relative_transform = LayerTransformOrOffset::identity();
...
pub struct ReferenceFrameInfo {
    ...
    pub resolved_transform: LayerTransformOrOffset,
    ...
    pub source_perspective: LayoutTransformOrOffset,
