...
pub enum NodeType {
    ...
    ReferenceFrame(LayerToScrollTransform, LayerVector2D),
...
impl ClipScrollNode {
    ...
    pub fn new_reference_frame(parent_id: Option<ClipId>,
        ...
        ClipScrollNode {
            ...
            children: Vec::new(),
            pipeline_id,
            node_type: NodeType::ReferenceFrame(*local_transform, original_origin),
        }
    }
