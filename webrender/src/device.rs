...
impl VertexFormat {
    fn bind(&self, gl_: &Rc<gl::Gl>, main: VBOId, instance: VBOId, offset: gl::GLuint, instance_stride: gl::GLint) {
        main.bind(gl_);

        match *self {
            VertexFormat::DebugFont => {
                gl_.enable_vertex_attrib_array(VertexAttribute::Position as gl::GLuint);
                gl_.enable_vertex_attrib_array(VertexAttribute::Color as gl::GLuint);
                gl_.enable_vertex_attrib_array(VertexAttribute::ColorTexCoord as gl::GLuint);

                gl_.vertex_attrib_divisor(VertexAttribute::Position as gl::GLuint, 0);
                gl_.vertex_attrib_divisor(VertexAttribute::Color as gl::GLuint, 0);
                gl_.vertex_attrib_divisor(VertexAttribute::ColorTexCoord as gl::GLuint, 0);

                let vertex_stride = mem::size_of::<DebugFontVertex>() as gl::GLuint;

                gl_.vertex_attrib_pointer(VertexAttribute::Position as gl::GLuint,
                                          2,
                                          gl::FLOAT,
                                          false,
                                          vertex_stride as gl::GLint,
                                          0 + vertex_stride * offset);
                gl_.vertex_attrib_pointer(VertexAttribute::Color as gl::GLuint,
                                          4,
                                          gl::UNSIGNED_BYTE,
                                          true,
                                          vertex_stride as gl::GLint,
                                          8 + vertex_stride * offset);
                gl_.vertex_attrib_pointer(VertexAttribute::ColorTexCoord as gl::GLuint,
                                          2,
                                          gl::FLOAT,
                                          false,
                                          vertex_stride as gl::GLint,
            ...
            VertexFormat::Triangles => {
                ...
                for &attrib in [VertexAttribute::GlobalPrimId,
                    ...
                    gl_.enable_vertex_attrib_array(attrib as gl::GLuint);
                    gl_.vertex_attrib_divisor(attrib as gl::GLuint, 1);
                    gl_.vertex_attrib_i_pointer(attrib as gl::GLuint,
                                                1,
                                                gl::INT,
                                                instance_stride,
                                                offset);
                ...
                gl_.enable_vertex_attrib_array(VertexAttribute::UserData as gl::GLuint);
                gl_.vertex_attrib_divisor(VertexAttribute::UserData as gl::GLuint, 1);
                gl_.vertex_attrib_i_pointer(VertexAttribute::UserData as gl::GLuint,
                                            2,
                                            gl::INT,
                                            instance_stride,
                                            offset);
            ...
            VertexFormat::Clear => {
                let vertex_stride = mem::size_of::<PackedVertex>() as gl::GLuint;
                gl_.enable_vertex_attrib_array(ClearAttribute::Position as gl::GLuint);
                gl_.vertex_attrib_divisor(ClearAttribute::Position as gl::GLuint, 0);

                gl_.vertex_attrib_pointer(ClearAttribute::Position as gl::GLuint,
                                          2,
                                          gl::FLOAT,
                                          false,
                                          vertex_stride as gl::GLint,
                ...
                gl_.enable_vertex_attrib_array(ClearAttribute::Rectangle as gl::GLuint);
                gl_.vertex_attrib_divisor(ClearAttribute::Rectangle as gl::GLuint, 1);
                gl_.vertex_attrib_i_pointer(ClearAttribute::Rectangle as gl::GLuint,
                                            4,
                                            gl::INT,
                                            instance_stride,
                                            0);
            ...
            VertexFormat::Blur => {
                let vertex_stride = mem::size_of::<PackedVertex>() as gl::GLuint;
                gl_.enable_vertex_attrib_array(BlurAttribute::Position as gl::GLuint);
                gl_.vertex_attrib_divisor(BlurAttribute::Position as gl::GLuint, 0);

                gl_.vertex_attrib_pointer(BlurAttribute::Position as gl::GLuint,
                                          2,
                                          gl::FLOAT,
                                          false,
                                          vertex_stride as gl::GLint,
            ...
            VertexFormat::Clip => {
                let vertex_stride = mem::size_of::<PackedVertex>() as gl::GLuint;
                gl_.enable_vertex_attrib_array(ClipAttribute::Position as gl::GLuint);
                gl_.vertex_attrib_divisor(ClipAttribute::Position as gl::GLuint, 0);

                gl_.vertex_attrib_pointer(ClipAttribute::Position as gl::GLuint,
                                          2,
                                          gl::FLOAT,
                                          false,
                                          vertex_stride as gl::GLint,
...
impl TextureId {
    pub fn bind(&self, gl_: &Rc<gl::Gl>) {
        gl_.bind_texture(self.target, self.name);
    }
...
impl ProgramId {
    fn bind(&self, gl_: &Rc<gl::Gl>) {
        gl_.use_program(self.0);
    }
}

impl VBOId {
    fn bind(&self, gl_: &Rc<gl::Gl>) {
        gl_.bind_buffer(gl::ARRAY_BUFFER, self.0);
    }
}

impl IBOId {
    fn bind(&self, gl_: &Rc<gl::Gl>) {
        gl_.bind_buffer(gl::ELEMENT_ARRAY_BUFFER, self.0);
    }
}

impl UBOId {
    fn _bind(&self, gl_: &Rc<gl::Gl>) {
        gl_.bind_buffer(gl::UNIFORM_BUFFER, self.0);
    }
}

impl FBOId {
    fn bind(&self, gl_: &Rc<gl::Gl>, target: FBOTarget) {
        let target = match target {
            FBOTarget::Read => gl::READ_FRAMEBUFFER,
            FBOTarget::Draw => gl::DRAW_FRAMEBUFFER,
        };
        gl_.bind_framebuffer(target, self.0);
    }
}
...
impl Drop for Texture {
    fn drop(&mut self) {
        if !self.fbo_ids.is_empty() {
            ...
            self.gl_.delete_framebuffers(&fbo_ids[..]);
        }
        self.gl_.delete_textures(&[self.id]);
    }
}
...
impl Program {
    fn attach_and_bind_shaders(&mut self,
        ...
        self.gl_.attach_shader(self.id, vs_id);
        self.gl_.attach_shader(self.id, fs_id);

        match vertex_format {
            VertexFormat::Triangles | VertexFormat::Rectangles |
            VertexFormat::DebugFont |  VertexFormat::DebugColor => {
                self.gl_.bind_attrib_location(self.id, VertexAttribute::Position as gl::GLuint, "aPosition");
                self.gl_.bind_attrib_location(self.id, VertexAttribute::Color as gl::GLuint, "aColor");
                self.gl_.bind_attrib_location(self.id, VertexAttribute::ColorTexCoord as gl::GLuint, "aColorTexCoord");

                self.gl_.bind_attrib_location(self.id, VertexAttribute::GlobalPrimId as gl::GLuint, "aGlobalPrimId");
                self.gl_.bind_attrib_location(self.id, VertexAttribute::PrimitiveAddress as gl::GLuint, "aPrimitiveAddress");
                self.gl_.bind_attrib_location(self.id, VertexAttribute::TaskIndex as gl::GLuint, "aTaskIndex");
                self.gl_.bind_attrib_location(self.id, VertexAttribute::ClipTaskIndex as gl::GLuint, "aClipTaskIndex");
                self.gl_.bind_attrib_location(self.id, VertexAttribute::LayerIndex as gl::GLuint, "aLayerIndex");
                self.gl_.bind_attrib_location(self.id, VertexAttribute::ElementIndex as gl::GLuint, "aElementIndex");
                self.gl_.bind_attrib_location(self.id, VertexAttribute::UserData as gl::GLuint, "aUserData");
                self.gl_.bind_attrib_location(self.id, VertexAttribute::ZIndex as gl::GLuint, "aZIndex");
            }
            VertexFormat::Clear => {
                self.gl_.bind_attrib_location(self.id, ClearAttribute::Position as gl::GLuint, "aPosition");
                self.gl_.bind_attrib_location(self.id, ClearAttribute::Rectangle as gl::GLuint, "aClearRectangle");
            }
            VertexFormat::Blur => {
                self.gl_.bind_attrib_location(self.id, BlurAttribute::Position as gl::GLuint, "aPosition");
                self.gl_.bind_attrib_location(self.id, BlurAttribute::RenderTaskIndex as gl::GLuint, "aBlurRenderTaskIndex");
                self.gl_.bind_attrib_location(self.id, BlurAttribute::SourceTaskIndex as gl::GLuint, "aBlurSourceTaskIndex");
                self.gl_.bind_attrib_location(self.id, BlurAttribute::Direction as gl::GLuint, "aBlurDirection");
            }
            VertexFormat::Clip => {
                self.gl_.bind_attrib_location(self.id, ClipAttribute::Position as gl::GLuint, "aPosition");
                self.gl_.bind_attrib_location(self.id, ClipAttribute::RenderTaskIndex as gl::GLuint, "aClipRenderTaskIndex");
                self.gl_.bind_attrib_location(self.id, ClipAttribute::LayerIndex as gl::GLuint, "aClipLayerIndex");
                self.gl_.bind_attrib_location(self.id, ClipAttribute::DataIndex as gl::GLuint, "aClipDataIndex");
                self.gl_.bind_attrib_location(self.id, ClipAttribute::SegmentIndex as gl::GLuint, "aClipSegmentIndex");
            }
        }

        self.gl_.link_program(self.id);
        if self.gl_.get_program_iv(self.id, gl::LINK_STATUS) == (0 as gl::GLint) {
            let error_log = self.gl_.get_program_info_log(self.id);
            println!("Failed to link shader program: {}", error_log);
            self.gl_.detach_shader(self.id, vs_id);
            self.gl_.detach_shader(self.id, fs_id);
...
impl Drop for Program {
    fn drop(&mut self) {
        self.gl_.delete_program(self.id);
    }
}
...
impl Drop for VAO {
    fn drop(&mut self) {
        self.gl_.delete_vertex_arrays(&[self.id]);

        if self.owns_indices {
            // todo(gw): maybe make these their own type with hashmap?
            self.gl_.delete_buffers(&[self.ibo_id.0]);
        }
        if self.owns_vertices {
            self.gl_.delete_buffers(&[self.main_vbo_id.0]);
        }
        if self.owns_instances {
            self.gl_.delete_buffers(&[self.instance_vbo_id.0])
        }
    }
}
...
impl<T> GpuFrameProfile<T> {
    ...
    fn new(gl_: Rc<gl::Gl>) -> GpuFrameProfile<T> {
        let queries = gl_.gen_queries(MAX_EVENTS_PER_FRAME as gl::GLint);
    ...
    where T: NamedTag {
        ...
        let marker = GpuMarker::new(self.gl_.clone(), tag.get_label());

        if self.next_query < MAX_EVENTS_PER_FRAME {
            self.pending_query = self.queries[self.next_query];
            self.gl_.begin_query(gl::TIME_ELAPSED, self.pending_query);
    ...
    fn build_samples(&mut self) -> Vec<GpuSample<T>> {
        for (index, sample) in self.samples.iter_mut().enumerate() {
            sample.time_ns = self.gl_.get_query_object_ui64v(self.queries[index], gl::QUERY_RESULT)
        }
...
impl<T> Drop for GpuFrameProfile<T> {
    #[cfg(not(target_os = "android"))]
    fn drop(&mut self) {
        self.gl_.delete_queries(&self.queries);
    }
...
impl<T> GpuProfiler<T> {
    pub fn new(gl_: Rc<gl::Gl>) -> GpuProfiler<T> {
        GpuProfiler {
            next_frame: 0,
            frames: [
                      GpuFrameProfile::new(gl_.clone()),
                      GpuFrameProfile::new(gl_.clone()),
                      GpuFrameProfile::new(gl_.clone()),
                      GpuFrameProfile::new(gl_.clone()),
                    ],
...
#[cfg(any(target_arch="arm", target_arch="aarch64"))]
impl GpuMarker {
    pub fn new(gl_: Rc<gl::Gl>, _: &str) -> GpuMarker {
        GpuMarker{
            gl_: gl_,
        }
    }

    pub fn fire(gl_: &gl::Gl, _: &str) {}
}


#[cfg(not(any(target_arch="arm", target_arch="aarch64")))]
impl GpuMarker {
    pub fn new(gl_: Rc<gl::Gl>, message: &str) -> GpuMarker {
        gl_.push_group_marker_ext(message);
        GpuMarker{
            gl_: gl_,
        }
    }

    pub fn fire(gl_: &gl::Gl, message: &str) {
        gl_.insert_event_marker_ext(message);
    }
}
...
impl Device {
    pub fn new(gl_: Rc<gl::Gl>,
        ...
        let max_ubo_size = gl_.get_integer_v(gl::MAX_UNIFORM_BLOCK_SIZE) as usize;
        let max_texture_size = gl_.get_integer_v(gl::MAX_TEXTURE_SIZE) as u32;
    ...
    pub fn compile_shader(gl_: &Rc<gl::Gl>,
                          name: &str,
                          source_str: &str,
        ...
        let id = gl_.create_shader(shader_type);
        let mut source = Vec::new();
        source.extend_from_slice(s.as_bytes());
        gl_.shader_source(id, &[&source[..]]);
        gl_.compile_shader(id);
        let log = gl_.get_shader_info_log(id);
        if gl_.get_shader_iv(id, gl::COMPILE_STATUS) == (0 as gl::GLint) {
    ...
    pub fn begin_frame(&mut self, device_pixel_ratio: f32) {
        ...
        let default_read_fbo = self.gl_.get_integer_v(gl::READ_FRAMEBUFFER_BINDING);
        self.default_read_fbo = default_read_fbo as gl::GLuint;
        let default_draw_fbo = self.gl_.get_integer_v(gl::DRAW_FRAMEBUFFER_BINDING);
        self.default_draw_fbo = default_draw_fbo as gl::GLuint;

        // Texture state
        for i in 0..self.bound_textures.len() {
            self.bound_textures[i] = TextureId::invalid();
            self.gl_.active_texture(gl::TEXTURE0 + i as gl::GLuint);
        ...
        // Pixel op state
        self.gl_.pixel_store_i(gl::UNPACK_ALIGNMENT, 1);

        // Default is sampler 0, always
        self.gl_.active_texture(gl::TEXTURE0);
    }
    ...
    pub fn bind_texture(&mut self,
        ...
        if self.bound_textures[sampler_index] != texture_id {
            ...
            self.gl_.active_texture(gl::TEXTURE0 + sampler_index as gl::GLuint);
            texture_id.bind(&self.gl_);
            self.gl_.active_texture(gl::TEXTURE0);
        }
    }
    ...
    pub fn bind_read_target(&mut self, texture_id: Option<(TextureId, i32)>) {
        ...
        if self.bound_read_fbo != fbo_id {
            ...
            fbo_id.bind(&self.gl_, FBOTarget::Read);
        }
    }
    ...
    pub fn bind_draw_target(&mut self,
        ...
        if self.bound_draw_fbo != fbo_id {
            ...
            fbo_id.bind(&self.gl_, FBOTarget::Draw);
        }

        if let Some(dimensions) = dimensions {
            self.gl_.viewport(0, 0, dimensions.width as gl::GLint, dimensions.height as gl::GLint);
        }
    }
    ...
    pub fn create_texture_ids(&mut self,
        ...
        let id_list = self.gl_.gen_textures(count);
    ...
    fn set_texture_parameters(&mut self, target: gl::GLuint, filter: TextureFilter) {
        ...
        self.gl_.tex_parameter_i(target, gl::TEXTURE_MAG_FILTER, filter as gl::GLint);
        self.gl_.tex_parameter_i(target, gl::TEXTURE_MIN_FILTER, filter as gl::GLint);

        self.gl_.tex_parameter_i(target, gl::TEXTURE_WRAP_S, gl::CLAMP_TO_EDGE as gl::GLint);
        self.gl_.tex_parameter_i(target, gl::TEXTURE_WRAP_T, gl::CLAMP_TO_EDGE as gl::GLint);
    }
    ...
    pub fn create_fbo_for_texture_if_necessary(&mut self,
        ...
        match layer_count {
            Some(layer_count) => {
                ...
                self.gl_.tex_image_3d(texture_id.target,
                                      0,
                                      internal_format as gl::GLint,
                ...
                let new_fbos = self.gl_.gen_framebuffers(needed_layer_count);
                texture.fbo_ids.extend(new_fbos.into_iter().map(|id| FBOId(id)));

                for (fbo_index, fbo_id) in texture.fbo_ids.iter().enumerate() {
                    self.gl_.bind_framebuffer(gl::FRAMEBUFFER, fbo_id.0);
                    self.gl_.framebuffer_texture_layer(gl::FRAMEBUFFER,
                    ...
                    let renderbuffer_ids = self.gl_.gen_renderbuffers(1);
                    let depth_rb = renderbuffer_ids[0];
                    self.gl_.bind_renderbuffer(gl::RENDERBUFFER, depth_rb);
                    self.gl_.renderbuffer_storage(gl::RENDERBUFFER,
                                                  gl::DEPTH_COMPONENT24,
                                                  texture.width as gl::GLsizei,
                                                  texture.height as gl::GLsizei);
                    self.gl_.framebuffer_renderbuffer(gl::FRAMEBUFFER,
                                                      gl::DEPTH_ATTACHMENT,
                                                      gl::RENDERBUFFER,
                                                      depth_rb);
                }
            ...
            None => {
                ...
                if texture.fbo_ids.is_empty() {
                    let new_fbo = self.gl_.gen_framebuffers(1)[0];

                    self.gl_.bind_framebuffer(gl::FRAMEBUFFER, new_fbo);

                    self.gl_.framebuffer_texture_2d(gl::FRAMEBUFFER,
                                                    gl::COLOR_ATTACHMENT0,
                                                    texture_id.target,
                                                    texture_id.name,
                                                    0);
        ...
        self.gl_.bind_framebuffer(gl::READ_FRAMEBUFFER, self.bound_read_fbo.0);
        self.gl_.bind_framebuffer(gl::DRAW_FRAMEBUFFER, self.bound_draw_fbo.0);
    }
    ...
    pub fn blit_render_target(&mut self,
        ...
        self.gl_.blit_framebuffer(src_rect.origin.x,
                                  src_rect.origin.y,
    ...
    pub fn resize_texture(&mut self,
        ...
        self.gl_.copy_tex_sub_image_2d(temp_texture_id.target,
                                       0,
                                       0,
                                       0,
                                       0,
        ...
        self.gl_.copy_tex_sub_image_2d(texture_id.target,
                                       0,
                                       0,
                                       0,
                                       0,
    ...
    pub fn deinit_texture(&mut self, texture_id: TextureId) {
        ...
        self.gl_.tex_image_2d(texture_id.target,
                              0,
                              internal_format,
                              0,
                              0,
    ...
    pub fn create_program_with_prefix(&mut self,
        ...
        let pid = self.gl_.create_program();
    ...
    fn load_program(&mut self,
        ...
        let vs_id = try!{ Device::compile_shader(&self.gl_,
                                                 &program.name,
                                                 &program.vs_source,
                                                 gl::VERTEX_SHADER,
                                                 &vs_preamble) };
        let fs_id = try!{ Device::compile_shader(&self.gl_,
                                                 &program.name,
                                                 &program.fs_source,
                                                 gl::FRAGMENT_SHADER,
                                                 &fs_preamble) };
        ...
        if let Some(vs_id) = program.vs_id {
            self.gl_.detach_shader(program.id, vs_id);
        }

        if let Some(fs_id) = program.fs_id {
            self.gl_.detach_shader(program.id, fs_id);
        }
        ...
        if let Err(bind_error) = program.attach_and_bind_shaders(vs_id, fs_id, vertex_format) {
            ...
            if let Some(vs_id) = program.vs_id {
                self.gl_.delete_shader(vs_id);
            }

            if let Some(fs_id) = program.fs_id {
                self.gl_.delete_shader(fs_id);
            }
        ...
        program.u_transform = self.gl_.get_uniform_location(program.id, "uTransform");
        program.u_device_pixel_ratio = self.gl_.get_uniform_location(program.id, "uDevicePixelRatio");

        program_id.bind(&self.gl_);
        let u_color_0 = self.gl_.get_uniform_location(program.id, "sColor0");
        if u_color_0 != -1 {
            self.gl_.uniform_1i(u_color_0, TextureSampler::Color0 as i32);
        }
        let u_color1 = self.gl_.get_uniform_location(program.id, "sColor1");
        if u_color1 != -1 {
            self.gl_.uniform_1i(u_color1, TextureSampler::Color1 as i32);
        }
        let u_color_2 = self.gl_.get_uniform_location(program.id, "sColor2");
        if u_color_2 != -1 {
            self.gl_.uniform_1i(u_color_2, TextureSampler::Color2 as i32);
        }
        let u_mask = self.gl_.get_uniform_location(program.id, "sMask");
        if u_mask != -1 {
            self.gl_.uniform_1i(u_mask, TextureSampler::Mask as i32);
        }

        let u_cache = self.gl_.get_uniform_location(program.id, "sCache");
        if u_cache != -1 {
            self.gl_.uniform_1i(u_cache, TextureSampler::Cache as i32);
        }

        let u_layers = self.gl_.get_uniform_location(program.id, "sLayers");
        if u_layers != -1 {
            self.gl_.uniform_1i(u_layers, TextureSampler::Layers as i32);
        }

        let u_tasks = self.gl_.get_uniform_location(program.id, "sRenderTasks");
        if u_tasks != -1 {
            self.gl_.uniform_1i(u_tasks, TextureSampler::RenderTasks as i32);
        }

        let u_prim_geom = self.gl_.get_uniform_location(program.id, "sPrimGeometry");
        if u_prim_geom != -1 {
            self.gl_.uniform_1i(u_prim_geom, TextureSampler::Geometry as i32);
        }

        let u_data16 = self.gl_.get_uniform_location(program.id, "sData16");
        if u_data16 != -1 {
            self.gl_.uniform_1i(u_data16, TextureSampler::Data16 as i32);
        }

        let u_data32 = self.gl_.get_uniform_location(program.id, "sData32");
        if u_data32 != -1 {
            self.gl_.uniform_1i(u_data32, TextureSampler::Data32 as i32);
        }

        let u_data64 = self.gl_.get_uniform_location(program.id, "sData64");
        if u_data64 != -1 {
            self.gl_.uniform_1i(u_data64, TextureSampler::Data64 as i32);
        }

        let u_data128 = self.gl_.get_uniform_location(program.id, "sData128");
        if u_data128 != -1 {
            self.gl_.uniform_1i(u_data128, TextureSampler::Data128    as i32);
        }

        let u_resource_rects = self.gl_.get_uniform_location(program.id, "sResourceRects");
        if u_resource_rects != -1 {
            self.gl_.uniform_1i(u_resource_rects, TextureSampler::ResourceRects as i32);
        }

        let u_gradients = self.gl_.get_uniform_location(program.id, "sGradients");
        if u_gradients != -1 {
            self.gl_.uniform_1i(u_gradients, TextureSampler::Gradients as i32);
        }
...
/*
    ...
    fn set_uniforms(&self,
                    ...
                    device_pixel_ratio: f32) {
        debug_assert!(self.inside_frame);
        self.gl_.uniform_matrix_4fv(program.u_transform,
                               false,
                               &transform.to_row_major_array());
        self.gl_.uniform_1f(program.u_device_pixel_ratio, device_pixel_ratio);
    }
    ...
    fn update_image_for_2d_texture(&mut self,
                                   ...
                                   format: gl::GLuint,
                                   data: &[u8]) {
        self.gl_.tex_sub_image_2d(target,
                                  0,
                                  x0, y0,
                                  width, height,
                                  format,
    ...
    pub fn update_texture(&mut self,
        ...
        if let Some(..) = stride {
            self.gl_.pixel_store_i(gl::UNPACK_ROW_LENGTH, row_length as gl::GLint);
        }
        ...
        if let Some(..) = stride {
            self.gl_.pixel_store_i(gl::UNPACK_ROW_LENGTH, 0 as gl::GLint);
        }
    }
    ...
    fn create_vao_with_vbos(&mut self,
        ...
        let vao_ids = self.gl_.gen_vertex_arrays(1);
        let vao_id = vao_ids[0];

        self.gl_.bind_vertex_array(vao_id);

        format.bind(&self.gl_, main_vbo_id, instance_vbo_id, vertex_offset, instance_stride);
        ibo_id.bind(&self.gl_); // force it to be a part of VAO
    ...
    pub fn create_vao(&mut self, format: VertexFormat, inst_stride: gl::GLint) -> VAOId {
        ...
        let buffer_ids = self.gl_.gen_buffers(3);
    ...
    pub fn create_vao_with_new_instances(&mut self, format: VertexFormat, inst_stride: gl::GLint,
        ...
        let buffer_ids = self.gl_.gen_buffers(1);
    ...
    pub fn update_vao_instances<V>(&mut self,
        ...
        vao.instance_vbo_id.bind(&self.gl_);
    ...
    pub fn draw_triangles_u16(&mut self, first_vertex: i32, index_count: i32) {
        debug_assert!(self.inside_frame);
        self.gl_.draw_elements(gl::TRIANGLES,
                               index_count,
                               gl::UNSIGNED_SHORT,
    ...
    pub fn draw_indexed_triangles_instanced_u16(&mut self,
                                                ...
                                                instance_count: i32) {
        debug_assert!(self.inside_frame);
        self.gl_.draw_elements_instanced(gl::TRIANGLES, index_count, gl::UNSIGNED_SHORT, 0, instance_count);
    }
    ...
    pub fn assign_ubo_binding(&self, program_id: ProgramId, name: &str, value: u32) -> u32 {
        let index = self.gl_.get_uniform_block_index(program_id.0, name);
        self.gl_.uniform_block_binding(program_id.0, index, value);
        index
    }

    pub fn create_ubo<T>(&self, data: &[T], binding: u32) -> UBOId {
        let ubo = self.gl_.gen_buffers(1)[0];
        self.gl_.bind_buffer(gl::UNIFORM_BUFFER, ubo);
        gl::buffer_data(self.gl(), gl::UNIFORM_BUFFER, data, gl::STATIC_DRAW);
        self.gl_.bind_buffer_base(gl::UNIFORM_BUFFER, binding, ubo);
        UBOId(ubo)
    }

    pub fn reset_ubo(&self, binding: u32) {
        self.gl_.bind_buffer(gl::UNIFORM_BUFFER, 0);
        self.gl_.bind_buffer_base(gl::UNIFORM_BUFFER, binding, 0);
    }

    pub fn delete_buffer(&self, buffer: UBOId) {
        self.gl_.delete_buffers(&[buffer.0]);
    }
    ...
    pub fn set_multisample(&self, enable: bool) {
        if self.capabilities.supports_multisampling {
            if enable {
                self.gl_.enable(gl::MULTISAMPLE);
            } else {
                self.gl_.disable(gl::MULTISAMPLE);
            }
        }
    }
    ...
    pub fn clear_target(&self,
        ...
        if let Some(color) = color {
            self.gl_.clear_color(color[0], color[1], color[2], color[3]);
            clear_bits |= gl::COLOR_BUFFER_BIT;
        }

        if let Some(depth) = depth {
            self.gl_.clear_depth(depth as f64);
            clear_bits |= gl::DEPTH_BUFFER_BIT;
        }

        if clear_bits != 0 {
            self.gl_.clear(clear_bits);
        }
    }
    ...
    pub fn clear_target_rect(&self,
        ...
        if clear_bits != 0 {
            self.gl_.enable(gl::SCISSOR_TEST);
            self.gl_.scissor(rect.origin.x, rect.origin.y, rect.size.width, rect.size.height);
            self.gl_.clear(clear_bits);
            self.gl_.disable(gl::SCISSOR_TEST);
        }
    }
    ...
    pub fn set_depth_func(&self, depth_func: DepthFunction) {
        self.gl_.depth_func(depth_func as gl::GLuint);
    }
    ...
    pub fn set_blend_mode_premultiplied_alpha(&self) {
        self.gl_.blend_func(gl::SRC_ALPHA, gl::ZERO);
        self.gl_.blend_equation(gl::FUNC_ADD);
    }

    pub fn set_blend_mode_alpha(&self) {
        //self.gl_.blend_func(gl::SRC_ALPHA, gl::ONE_MINUS_SRC_ALPHA);
        self.gl_.blend_func_separate(gl::SRC_ALPHA, gl::ONE_MINUS_SRC_ALPHA,
                                     gl::ONE, gl::ONE);
        self.gl_.blend_equation(gl::FUNC_ADD);
    }

    pub fn set_blend_mode_subpixel(&self, color: ColorF) {
        self.gl_.blend_color(color.r, color.g, color.b, color.a);
        self.gl_.blend_func(gl::CONSTANT_COLOR, gl::ONE_MINUS_SRC_COLOR);
    }

    pub fn set_blend_mode_multiply(&self) {
        self.gl_.blend_func_separate(gl::ZERO, gl::SRC_COLOR,
                                     gl::ZERO, gl::SRC_ALPHA);
        self.gl_.blend_equation(gl::FUNC_ADD);
    }
    pub fn set_blend_mode_max(&self) {
        self.gl_.blend_func_separate(gl::ONE, gl::ONE,
                                     gl::ONE, gl::ONE);
        self.gl_.blend_equation_separate(gl::MAX, gl::FUNC_ADD);
    }
    pub fn set_blend_mode_min(&self) {
        self.gl_.blend_func_separate(gl::ONE, gl::ONE,
                                     gl::ONE, gl::ONE);
        self.gl_.blend_equation_separate(gl::MIN, gl::FUNC_ADD);
    }
}
