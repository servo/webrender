...
impl FrameBuilder {
    ...
    pub fn get_packed_layer_index_if_visible(
        ...
        //Note: this ignores `group_ref.visibility` intentionally
        // it is used at the start of culling, which is what's going to evaluate
        // the visibility of this cs-group with regards to the cs-tree
