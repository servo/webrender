    ...
    pub fn update(
        ...
        self.cache_key.raster_transform = match raster_space {
            RasterSpace::Screen => {
                ...
                let raster_spatial_node = &clip_scroll_tree.spatial_nodes[raster_spatial_node_index];
                let surface_spatial_node = &clip_scroll_tree.spatial_nodes[surface_spatial_node_index];
