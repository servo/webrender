...
use core_foundation::base::{TCFType, CFType, CFTypeRef};
...
impl FontContext {
    ...
    fn get_ct_font(&mut self,
                   font_key: FontKey,
                   size: Au,
                   variations: &[FontVariation]) -> Option<CTFont> {
    ...
    pub fn get_glyph_dimensions(&mut self,
        ...
        self.get_ct_font(font.font_key, font.size, &font.variations).and_then(|ref ct_font| {
