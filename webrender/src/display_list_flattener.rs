...
use clip_scroll_node::{ClipScrollNode, NodeType, PositioningNodeType, StickyFrameInfo};
...
impl<'a> DisplayListFlattener<'a> {
    ...
    pub fn setup_viewport_offset(
        ...
        if let NodeType::Positioning { kind: PositioningNodeType::ReferenceFrame(ref mut info), .. } = root_node.node_type {
