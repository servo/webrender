...
pub struct TextRunPrimitive {
    ...
    pub glyph_keys_range: Range<GlyphKeyIndex>,
    pub shadow: bool,
}
...
impl TextRunPrimitive {
    ...
    fn prepare_for_render(
        ...
        glyph_keys: &mut GlyphKeysStorage,
    ) {
...
storage_index_impl!(GlyphKeyIndex, TextRunIndex);
pub type TextRunStorage = Storage<TextRunPrimitive, TextRunIndex>;
pub type GlyphKeysStorage = Storage<GlyphKey, GlyphKeyIndex>;
...
pub struct PrimitiveStore {
    ...
    pub glyph_keys: GlyphKeysStorage,
