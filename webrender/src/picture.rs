...
impl PicturePrimitive {
    ...
    pub fn prepare_for_render(
        ...
        let content_scale = LayerToWorldScale::new(1.0) * prim_run_context.device_pixel_scale;
        ...
        match self.kind {
            PictureKind::Image {
                ...
                match composite_mode {
                    Some(PictureCompositeMode::Filter(FilterOp::Blur(blur_radius))) => {
                        ...
                        let blur_std_deviation = blur_radius * prim_run_context.device_pixel_scale.0;
            ...
            PictureKind::TextShadow { blur_radius, color, content_rect, .. } => {
                ...
                let device_radius = (blur_radius * prim_run_context.device_pixel_scale.0).round();
