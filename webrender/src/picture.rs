...
use api::{DeviceIntPoint, DeviceIntRect, DeviceIntSize, LayerRect};
...
pub struct PictureCacheKey {
    ...
    pic_relative_device_rect: DeviceIntRect,
        ...
        match self.composite_mode {
            Some(PictureCompositeMode::Filter(FilterOp::Blur(blur_radius))) => {
                ...
                let surface = if pic_state_for_children.has_non_root_coord_system {
                    ...
                    let pic_relative_device_rect = DeviceIntRect::new(
                        DeviceIntPoint::new(
