...
mod glyph_rasterizer_ext_pathfinder;
#[cfg(feature = "pathfinder")]
use self::glyph_rasterizer_ext_pathfinder::{
    create_pathfinder_font_context};
#[cfg(feature = "pathfinder")]
pub use self::glyph_rasterizer_ext_pathfinder::{ThreadSafePathfinderFontContext, NativeFontHandleWrapper};

#[cfg(not(feature = "pathfinder"))]
mod glyph_rasterizer_ext_no_pathfinder;
#[cfg(not(feature = "pathfinder"))]
use self::glyph_rasterizer_ext_no_pathfinder::create_pathfinder_font_context;
