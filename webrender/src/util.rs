...
use webrender_traits::{LayerRect, WorldPoint3D, LayerPoint3D, LayerToWorldTransform};
...
/*
        match kind {
            ...
            TransformedRectKind::Complex => {
                */
                let vertices = [
                    transform.transform_point3d(&LayerPoint3D::new(rect.origin.x,
                                                                   rect.origin.y,
                                                                   0.0)),
                    transform.transform_point3d(&LayerPoint3D::new(rect.bottom_left().x,
                                                                   rect.bottom_left().y,
                                                                   0.0)),
                    transform.transform_point3d(&LayerPoint3D::new(rect.bottom_right().x,
                                                                   rect.bottom_right().y,
                                                                   0.0)),
                    transform.transform_point3d(&LayerPoint3D::new(rect.top_right().x,
                                                                   rect.top_right().y,
                                                                   0.0)),
                ];
