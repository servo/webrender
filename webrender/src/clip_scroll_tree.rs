...
fn test_cst_scale_translation() {
    ...
    // test_pt(100.0, 100.0, &cst, root, child2, -50.0, -25.0);
    // test_pt(100.0, 100.0, &cst, child4, root, 1600.0, 1950.0);
    // test_pt(1600.0, 1950.0, &cst, root, child4, 100.0, 100.0);

    // test_pt(0.0, 0.0, &cst, child4, child1, 800.0, 150.0);
    // test_pt(100.0, 100.0, &cst, child4, child1, 1200.0, 1350.0);
    // test_pt(100.0, 100.0, &cst, child2, child1, 200.0, 400.0);
    // test_pt(200.0, 400.0, &cst, child1, child2, 100.0, 100.0);

    // test_pt(100.0, 100.0, &cst, child3, child1, 600.0, 450.0);
    // test_pt(600.0, 450.0, &cst, child1, child3, 100.0, 100.0);
}
