...
use util::{LayerTransformOrOffset, LayerToWorldTransformOrOffset};
...
pub struct TransformUpdateState {
    pub parent_reference_frame_transform: LayerToWorldTransformOrOffset,
...
impl ClipScrollTree {
    ...
    pub fn update_tree(
        ...
        let mut state = TransformUpdateState {
            parent_reference_frame_transform: LayerToWorldTransformOrOffset::with_offset(
                LayerVector2D::new(pan.x, pan.y)
            ),
