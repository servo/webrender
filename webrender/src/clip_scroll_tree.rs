...
impl ClipScrollTree {
    ...
    pub fn root_reference_frame_id(&self) -> ClipScrollNodeIndex {
    ...
    pub fn topmost_scrolling_node_id(&self) -> ClipScrollNodeIndex {
        // TODO(mrobinson): We should eventually make this impossible to misuse.
    ...
    pub fn scroll(
        ...
        let non_root_overscroll = if node_index != topmost_scrolling_node_id {
    ...
    pub fn update_tree(
        ...
        let root_reference_frame_index = self.root_reference_frame_id();
    ...
    pub fn add_node(&mut self, node: ClipScrollNode, index: ClipScrollNodeIndex) {
        ...
        if index.0 > self.nodes.len() {
            ...
            while self.nodes.len() < index.0 + 1 {
                self.nodes.push(ClipScrollNode::empty());
            }
        }
