    ...
    fn update_document(
        ...
        if build_frame && doc.has_pixels() {
            ...
            *frame_counter += 1;
            ...
            // If frame is not rebuilt since last frame rendering and composite frame is
            // not requested, there is no need to render frame.
            if render_frame && !doc.rendered_frame_is_valid {
                render_frame = false;
            }
