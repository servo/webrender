...
impl RenderBackend {
    ...
    fn update_document(
        ...
        if let Some(updates) = doc_resource_updates {
            ...
            doc.resources.linear_grad_data_store.apply_updates(updates.linear_grad_updates);
            doc.resources.radial_grad_data_store.apply_updates(updates.radial_grad_updates);
