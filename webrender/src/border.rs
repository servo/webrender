...
fn add_corner_segment(
    ...
    let segment_rect = image_rect
        .intersection(&non_overlapping_rect)
    ...
    let (h_corner_outer, h_corner_radius) = match segment {
        BorderSegment::TopLeft => {
            if h_adjacent_corner_outer.x - h_adjacent_corner_radius.width < image_rect.max_x() {
                ...
                (
                    LayoutPoint::new(image_rect.max_x(), image_rect.min_y()),
                    LayoutSize::zero(),
                )
            }
        }
        BorderSegment::TopRight => {
            if h_adjacent_corner_outer.x + h_adjacent_corner_radius.width > image_rect.min_x() {
                ...
                (
                    LayoutPoint::new(image_rect.min_x(), image_rect.min_y()),
                    LayoutSize::zero(),
                )
            }
        }
        BorderSegment::BottomRight => {
            if h_adjacent_corner_outer.x + h_adjacent_corner_radius.width > image_rect.min_x() {
                ...
                (
                    LayoutPoint::new(image_rect.min_x(), image_rect.max_y()),
                    LayoutSize::zero(),
                )
            }
        }
