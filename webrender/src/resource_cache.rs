...
impl ResourceCache {
    pub fn new(texture_cache: TextureCache,
        ...
        let (glyph_cache_tx, glyph_cache_result_queue) = spawn_glyph_cache_thread(device_pixel_ratio);
...
fn spawn_glyph_cache_thread(device_pixel_ratio: f32) -> (Sender<GlyphCacheMsg>, Receiver<GlyphCacheResultMsg>) {
