...
pub const FONT_FORCE_AUTOHINT: u16  = 1 << 0;
pub const FONT_NO_AUTOHINT: u16     = 1 << 1;
pub const FONT_EMBEDDED_BITMAP: u16 = 1 << 2;
pub const FONT_EMBOLDEN: u16        = 1 << 3;
pub const FONT_VERTICAL_LAYOUT: u16 = 1 << 4;
pub const FONT_SUBPIXEL_BGR: u16    = 1 << 5;
